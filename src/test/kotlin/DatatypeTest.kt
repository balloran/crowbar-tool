...
class DatatypeTest : CrowbarTest() {
    init {
        for (smt in listOf(z3, cvc)){
            ...
            "$smt complexDataTypesParams"{
                ...
                val caseReturnWrappedFuncSuccess =
                    classDecl.extractMethodNode(postInv, "caseReturnWrappedFuncSuccess", repos)
            ...
            "$smt functors"{
                ...
                val doubleFuncAppTrivialSuccess =
                    classDecl.extractMethodNode(postInv, "doubleFuncAppTrivialSuccess", repos)
                executeNode(doubleFuncAppTrivialSuccess, repos, postInv) shouldBe true

                val doubleFuncAppTrivial2Success =
                    classDecl.extractMethodNode(postInv, "doubleFuncAppTrivial2Success", repos)
